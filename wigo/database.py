...
class Cassandra:
    ...
    __ERROR_KS_WIGO_ALREADY_EXISTS = 'Keyspace names must be case-insensitively unique ("wigo" conflicts with "wigo")'
    ...
    def setup(clazz):
        ...
        try:
            ...
            if e.why == clazz.__ERROR_KS_WIGO_ALREADY_EXISTS:
                pass
            else:
                raise e
        ...
        try:
            ...
            if e.why == clazz.__ERROR_CF_STATEMACHINES_ALREADY_EXISTS:
                pass
            else:
                raise e
